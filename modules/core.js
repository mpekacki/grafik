...
function getStoriesForDates(dateFrom, dateTo, cb){
	db.query('SELECT "nf_id", "author", "title", "date", "last_comment_count" FROM "Stories" LEFT JOIN "ContestsStories" ON "ContestsStories"."story_id" = "Stories"."nf_id" LEFT JOIN "Contests" ON "Contests"."id" = "ContestsStories"."contest_id" WHERE "date" >= $1 AND "date" < $2 AND ("included" = true OR "included" IS NULL);',
